...
pamac build gobject-introspection-git nautilus-admin nautilus-gnome-disks panther-launcher-git appmenu-gtk-module-git vala-panel-appmenu-registrar-git vala-panel-git vala-panel-appmenu-xfce-git lightdm-webkit2-theme-glorious plank-git ulauncher
